...
after this assign role to give permission to pull image from azure registry:

az role assignment create --assignee 9e6b4a89-1f17-49f6-990a-6337b3d69622(client id) --role AcrPull --scope /subscriptions/267d3f05-915b-4d44-a0d7-d39136ec12b6(subscription id)/resourceGroups/myResourceGroup/providers/Microsoft.ContainerRegistry/registries/myVotingACR

az role assignment list --assignee 9e6b4a89-1f17-49f6-990a-6337b3d69622 --scope /subscriptions/267d3f05-915b-4d44-a0d7-d39136ec12b6/resourceGroups/myResourceGroup/providers/Microsoft.ContainerRegistry/registries/myVotingACR --output table

to get client id:

root@localhost:~# az aks show --resource-group myResourceGroup --name votingapp --query "identityProfile.kubeletidentity.clientId" -o tsv
